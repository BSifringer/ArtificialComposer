...
duration_layers['input'] = Input(shape=(step_size, n_durations))
duration_layers['mask'] = Masking(mask_value=0)(duration_layers['input'])
duration_layers['GRU1'] = GRU(32, return_sequences=True)(duration_layers['mask'])
duration_layers['dropout1'] = Dropout(dropout_rate)(duration_layers['GRU1'])
duration_layers['GRU2'] = GRU(16, return_sequences=True)(duration_layers['dropout1'])
...
pitch_layers['input'] = Input(shape=(step_size, n_pitches))
pitch_layers['mask'] = Masking(mask_value=0)(pitch_layers['input'])
pitch_layers['GRU1'] = GRU(64, return_sequences=True)(pitch_layers['mask'])
pitch_layers['dropout1'] = Dropout(dropout_rate)(pitch_layers['GRU1'])
pitch_layers['GRU2'] = GRU(128, return_sequences=True)(pitch_layers['dropout1'])
pitch_layers['dropout2'] = Dropout(dropout_rate)(pitch_layers['GRU2'])
pitch_layers['GRU3'] = GRU(128, return_sequences=True)(pitch_layers['dropout2'])
...
duration_layers['GRU3'] = GRU(32, return_sequences=True)(duration_layers['merge'])
...
pitch_layers['GRU4'] = GRU(128, return_sequences=True)(pitch_layers['merge'])
pitch_layers['dropout4'] = Dropout(dropout_rate)(pitch_layers['GRU4'])
pitch_layers['GRU5'] = GRU(64, return_sequences=True)(pitch_layers['dropout4'])
...
pitch_layers['output'] = TimeDistributed(Dense(n_pitches, activation='softmax'))(pitch_layers['shortcut'])
