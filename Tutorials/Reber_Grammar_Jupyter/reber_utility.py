...
class State_machine:
    ...
    def __init__(self, current_state=None, state_transitions=None):
        ...
        self.index2trans = dict((i, self.transitions[i]) for i in range(len(self.transitions)))
...
def generate_reber_machine_continuous():
    current_state = 'Start'
    state_transitions = ({
        'Start': {'Start2': [1, 'B']},
        'Start2': {'T1': [0.5, 'T'], 'P1': [0.5, 'P']},
        'End': {'Start': [1, 'E']},

        'T1': {'ST': [1, 'B']},
        'ST': {'AT': [0.5, 'T'], 'CT': [0.5, 'V']},
        'ET': {'T2': [1, 'O']},
        'AT': {'AT': [0.5, 'P'], 'BT': [0.5, 'T']},
        'BT': {'CT': [0.5, 'X'], 'ET': [0.5, 'S']},
        'CT': {'CT': [0.5, 'X'], 'DT': [0.5, 'V']},
        'DT': {'BT': [0.5, 'P'], 'ET': [0.5, 'S']},
        'T2': {'T3': [1, 'E']},
        'T3': {'End': [1, 'T']},

        'P1': {'SP': [1, 'B']},
        'SP': {'AP': [0.5, 'T'], 'CP': [0.5, 'V']},
        'EP': {'P2': [1, 'O']},
        'AP': {'AP': [0.5, 'P'], 'BP': [0.5, 'T']},
        'BP': {'CP': [0.5, 'X'], 'EP': [0.5, 'S']},
        'CP': {'CP': [0.5, 'X'], 'DP': [0.5, 'V']},
        'DP': {'BP': [0.5, 'P'], 'EP': [0.5, 'S']},
        'P2': {'P3': [1, 'E']},
        'P3': {'End': [1, 'P']},
    })
    return State_machine(current_state, state_transitions)